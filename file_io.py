            ...
            try:
                ...
                try:
                    df_peek = pd.read_excel(
                        file_path, engine=engine, dtype=str, nrows=0, skiprows=[1]
                    )
    ...
    try:
        ...
        if ext in ['.xlsx', '.xls']:
            ...
            try:
                ...
                try:
                    dates_series = pd.read_excel(
                        file_path, engine=engine, usecols=[date_column_name], dtype=str
                    )[date_column_name]
            ...
            try:
                ...
                try:
                    dates_series = pd.read_csv(
                        file_path,
                        usecols=[date_column_name],
                        sep=sep,
                        engine="python",
                        encoding=enc,
                        on_bad_lines="skip",
